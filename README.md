...
This module was forked from `djjudas21/puppet-ossec`, which was forked from `nzin/puppet-ossec` to be packaged for Puppet
Forge. This fork is maintained to support the OSSEC deployment at my company, and as such may not be suitable for general
consumption.  At some point, many of the ideas in this fork will likely be submitted upstream, so feel free to contribute
any changes there.

## Release Notes

Author Nicolas Zin
Updated by Jonathan Gazeley
Maintained by Michael Porter